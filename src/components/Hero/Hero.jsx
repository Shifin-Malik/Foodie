        ...
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              <div>
                <button onClick={routeChange} className="bg-gradient-to-r from-primary to-secondary hover:scale-105 duration-200 text-white py-2 px-4 rounded-full">
                  Order Now
                </button>
              </div>
            </div>
                ...
                {ImageList.map((item) => (
                  <img
                    ...
                    onClick={() => {
                      setImageId(
                        item.id === 1
                          ? BiryaniImg1 : item.id === 2 
                          
                          ? BiryaniImg2 : BiryaniImg3 
